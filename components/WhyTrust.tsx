...
const REASONS = [
  ["01", "Авторский сценарий", "Пишу программу под ваш повод, а не достаю шаблон из папки."],
  ["02", "Держу зал", "От тёплых слёз до танцпола — веду эмоцию, а не просто объявляю блоки."],
  ["03", "Два языка", "Свободно веду на русском и казахском, смешиваю там, где это уместно."],
  ["04", "Тайминг по минутам", "Вечер идёт ровно, без пауз и неловкой тишины между блоками."],
  ["05", "Живой юмор", "Смешно и по-доброму — так, что не стыдно ни перед боссом, ни перед бабушкой."],
];
    ...
    >
      <div className="mx-auto max-w-[1500px] px-5 sm:px-8">
        ...
        <h2 className="why-title display text-[clamp(2.4rem,7vw,6rem)] mt-5 max-w-[30ch]">
          Пять причин доверить вечер <span className="text-accent">мне</span>
        </h2>
