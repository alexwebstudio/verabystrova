...
const STEPS = [
  ...
  ["04", "Подготавливаем сценарий", "Пишу авторский сценарий под вашу пару или компанию, согласую его до мелочей и закрепляю всё договором."],
  ["05", "Проводим мероприятие", "Держу вечер от первой минуты до финального танца: чувствую настроение зала и легко перестраиваюсь под ситуацию."],
